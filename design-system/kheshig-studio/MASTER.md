...
> **MARKA GEÇERSİZ KILAR — renkler logodan gelir, aşağıdaki jenerik palet değil.**
> `#890000` marka kırmızısı (yalnızca grafik/dolgu, metin için değil — siyah üstünde 1.97:1)
> `#E24A3E` vurgu kırmızısı (metin ve kontroller, 5.03:1 ✓)
> `#08080A` zemin · `#F4F2EF` metin · `#A5A1A0` ikincil metin (7.82:1 ✓)
> `#A31410` buton dolgusu (beyaz yazıyla 7.88:1 ✓)
> Yazı tipleri: Chakra Petch (başlık) · Geist (gövde) · Space Mono (etiket).
...
**Project:** Kheshig Studio
**Generated:** 2026-09-06 16:31:53
